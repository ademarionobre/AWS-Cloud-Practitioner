...
Este como outros materiais da própria AWS servem de guia para estudar.

# Tópicos de estudo

## 6 Vantagens do uso de Cloud Computing

1. Você Troca CAPEX(Capital Expense) por OPEX(Operational Expense) - Significa que você não se preocupa mais com o infra/hardware, apenas com as questões operacionais da sua aplicação.
2. Benefícios de grandes economias de escala. - Significa que teu gasto está totalmente adaptado ao teu consumo, não existe ociosidade, nem sobrecarregamento.
...
Escalabilidade vs Elasticidade vs Agilidade - (Atentar este item para o exame)
...
**S3** é o serviço de armazenamento de objetos da AWS, uso diverso, dentre elas:
...
Você pode configurar todas as questões de custo no AWS Cost Explorer console. Ver: <https://aws.amazon.com/savingsplans/pricing/>
...
**[Well Architected Framework General Guiding Principles]**(https://wa.aws.amazon.com/index.pt_BR.html) - Princípios que são pontos chave para a importância da utilização de infra na nuvem.
...
[Pilares](https://wa.aws.amazon.com/wat.pillars.wa-pillars.pt_BR.html)
...
Pilares do Well Achitected Framework:1 - **Excelência Operacional**  
A habilidade de rodar e monitorar sistemas para entregar valor de negócio e fazer melhoria continua em processos e procedimentos envolvidos.Princípios de Design:
...
Onde cada serviço se encaixa neste pilar? Não requerido no exame
...
Pilares do Well Achitected Framework:2- **Segurança**  
A habilidade de proteger informações, sistemas e assets enquanto entrega valor ao negócios, faz isso através de estratégias de mitigação e gerenciamento de riscos.  
...
Pilares do Well Achitected Framework:3 - **Confiabilidade** 
Habilidade de um sistema se recuperar de uma interrupção na infra ou serviços, adquirir recursos computacionais para se adequar a demanda e as suas variações e mitigar problemas como falhas de configurações ou issues transientes na rede.  
Princípios de design:
...
Onde cada serviço se encaixa neste pilar - Informativo, não requerido no exame.
...
Pilares do Well Achitected Framework:4- **Eficiência de Performance**  
A habilidade de usar recursos computacionais de forma eficiente para atingir os requisitos de sistema, e manter essa eficiência a medida em que mudanças ocorram e a tecnologia evolua.  
Princípios de design:
...
## 6º pilar: Susten
[Sustentabilidade](https://wa.aws.amazon.com/wat.pillar.sustainability.pt_BR.html)
Ao criar workloads em nuvem, a prática da sustentabilidade abrange ações como:
* Compreender o impacto dos serviços usados, quantificá-lo ao longo de todo o ciclo de vida da workload e aplicar princípios e práticas recomendadas de design para reduzi-lo.
* O pilar da sustentabilidade focaliza os impactos ambientais, especialmente a eficiência e o consumo de energia, que são fatores importantes para fundamentar ações diretas dos arquitetos visando reduzir o uso de recursos.  
Princípios:
...
Mais informações: <https://aws.amazon.com/pt/well-architected-tool/>
...
**Treinamentos oficiais AWS:**AWS Training**
...
Link informações sobre o exame: <https://aws.amazon.com/pt/certification/certified-cloud-practitioner/Leia:https://d1.awsstatic.com/pt_BR/training-and-certification/docs-cloud-practitioner/AWS-Certified-Cloud-Practitioner_Exam-Guide.pdf>
Questionário de exemplos: <https://d1.awsstatic.com/training-and-certification/docs-cloud-practitioner/AWS-Certified-Cloud-Practitioner_Sample-Questions.pdf>
